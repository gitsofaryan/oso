...
timeseries_metrics(
    ...
    timeseries_sources=[
        ...
        "int_events_daily__l2_internal_transactions",
        ...
        "int_events_aux_prs",
        "int_events_daily__worldchain_userops",
    ...
    metric_queries={
        ...
        "farcaster_users": MetricQueryDef(
            ref="blockchain/farcaster_users.sql",
            time_aggregations=[
                "daily",
                "weekly",
                "monthly",
            ...
            over_all_time=False,
            metadata=MetricMetadata(
                display_name="Farcaster Users",
                description="Metrics related to Farcaster users",
            ),
            additional_tags=["data_category=blockchain"],
        ),
        "layer2_gas_fees": MetricQueryDef(
            ref="blockchain/layer2_gas_fees.sql",
            time_aggregations=[
                "daily",
                "weekly",
                "monthly",
            ...
            over_all_time=True,
            metadata=MetricMetadata(
                display_name="Layer 2 Gas Fees",
                description="Metrics related to Layer 2 gas fees",
            ),
            additional_tags=["data_category=blockchain"],
        ),
        "layer2_gas_fees_amortized": MetricQueryDef(
            ref="blockchain/layer2_gas_fees_amortized.sql",
            time_aggregations=[
                "daily",
                "weekly",
                "monthly",
            ...
            over_all_time=True,
            metadata=MetricMetadata(
                display_name="Layer 2 Gas Fees Amortized",
                description="Metrics related to Layer 2 gas fees amortized",
            ),
            additional_tags=["data_category=blockchain"],
        ),
